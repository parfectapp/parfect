...
function vPlayerCard(u, agg) {
  ...
  if (agg) {
    ...
    const statIcon = {
      putt: `<svg viewBox="0 0 24 24" aria-hidden="true"><ellipse cx="19.4" cy="15.4" rx="3.8" ry="1.5" fill="#1f3a16"/><path d="M4 18 Q11 9.5 19 14.6" fill="none" stroke="#7cc24a" stroke-width="1.5" stroke-linecap="round" stroke-dasharray="1.5 3" opacity=".55"/><circle class="si-ball" cx="5.6" cy="17.2" r="3.3" fill="url(#g3dBall)" stroke="#cdd6cf" stroke-width=".5"/></svg>`,
