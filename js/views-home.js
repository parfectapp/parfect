...
function vPlayerCard(u, agg) {
  ...
  if (agg) {
    ...
    const statIcon = {
      ...
      three: `<svg viewBox="0 0 24 24" aria-hidden="true"><ellipse cx="12" cy="16" rx="9.5" ry="4" fill="url(#g3dGrass)"/><ellipse cx="12" cy="13.6" rx="2" ry=".8" fill="#16401c"/><path d="M12 13.6 V4" stroke="#2f3a16" stroke-width="1.6" stroke-linecap="round"/><path class="si-flagw" d="M12 4 L19 6.1 L12 8.2 Z" fill="#ff5a4d"/><circle class="si-tb1" cx="7.4" cy="16.6" r="1.8" fill="url(#g3dBall)"/><circle class="si-tb2" cx="12" cy="17.6" r="1.8" fill="url(#g3dBall)"/><circle class="si-tb3" cx="16.6" cy="16.2" r="1.8" fill="url(#g3dBall)"/></svg>`,
...
function vFeedCard() {
  ...
  return `<button class="auth-back" data-act="nav" data-view="social">← Feed de amigos</button>
    <div class="fd-card fd-card-full">
      ...
      ${p.cap ? `<p class="fd-cap fd-cap-btm">${esc(p.cap)}</p>` : ''}
    </div>
