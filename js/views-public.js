...
function vLanding() {
  ...
  const bgcPalm = (x, y, s, flip, d) => `<g class="bgc-palm" transform="translate(${x} ${y}) scale(${flip ? -s : s} ${s})"><ellipse class="bgc-gsh" cx="0" cy="2" rx="9" ry="2.2"/><path class="bgc-ptrunk" d="M-3,0 C-5,-13 3,-25 -2,-39 L2,-39 C6,-25 1,-13 3,0 Z"/><g class="bgc-pcrown" style="animation-delay:${d || 0}s" transform="translate(0 -38)"><path class="bgc-pleaf" d="M0,0 Q20,-3 29,9 Q21,0 1,3 Z"/><path class="bgc-pleaf" d="M0,0 Q-20,-3 -29,9 Q-21,0 -1,3 Z"/><path class="bgc-pleaf2" d="M0,-1 Q17,-11 31,-3 Q19,-1 1,3 Z"/><path class="bgc-pleaf2" d="M0,-1 Q-17,-11 -31,-3 Q-19,-1 -1,3 Z"/><path class="bgc-pleaf" d="M0,0 Q11,-15 23,-22 Q15,-9 1,2 Z"/><path class="bgc-pleaf" d="M0,0 Q-11,-15 -23,-22 Q-15,-9 -1,2 Z"/><path class="bgc-pleaf2" d="M-2,1 Q-2,-15 0,-25 Q2,-15 2,1 Z"/><circle class="bgc-pcoco" cx="-2.5" cy="2" r="1.7"/><circle class="bgc-pcoco" cx="2" cy="3" r="1.7"/><circle class="bgc-pcoco" cx="0" cy="0.5" r="1.5"/></g></g>`;
  ...
  const liveG = `${bgcPalm(20, 150, .7, false, -2)}${bgcPalm(34, 234, 1.7, false, 0)}${bgcPalm(378, 238, 2, true, -1.6)}${bgcPalm(210, 226, 1.3, false, -3)}${bgcBush(150, 226, 1.15)}${bgcBush(288, 216, 1)}${bgcBush(96, 210, .9)}${bgcBush(332, 232, .95)}`;
